            ...
            <fieldset class="col-xs-10 col-xs-offset-1">
                ...
                <form role="form" class="form-horizontal" method="POST" action="{{ route('login') }}">
                 ...
                 <div class="col-xs-10 col-xs-offset-1">
                    ...
                    <label class="col-xs-12" for="password"><h4>Contrase&ntilde;a</h4></label>
                 <div class="col-xs-10 col-xs-offset-1">
                    <input id="password" type="password" name="password" class="form-control col-xs-12 Input" required placeholder="Contraseña">
                    ...
                    <div class="form-group">
                        ...
                        <a class="btn center-block " href="{{ route('password.request') }}">Has olvidado tu Contrase&ntilde;a?</a>
                                                    </div>
